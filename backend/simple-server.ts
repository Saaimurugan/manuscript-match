...
app.listen(config.port, () => {
  console.log(`🚀 Simple server running on port ${config.port}`);
  console.log(`🔗 Health check: http://localhost:${config.port}/health`);
  console.log(`🔗 Test API: http://localhost:${config.port}/api/test`);
  console.log(`📁 Upload endpoint: http://localhost:${config.port}/api/processes/:id/upload`);
});